...
impl Mapper {
    pub fn new() -> Self {
        ...
        coff_fields.insert(
            ...
            FieldsMapper { offset: 2, size: 2 },
        );
        coff_fields.insert(
            "TimeDateStamp".to_string(),
            FieldsMapper { offset: 4, size: 4 },
        );
        coff_fields.insert(
            "PointerToSymbolTable".to_string(),
            FieldsMapper { offset: 8, size: 4 },
        );
        coff_fields.insert(
        ...
        pe32.insert(
            ...
            FieldsMapper { offset: 2, size: 1 },
        );
        pe32.insert(
            "MinorLinkerVersion".to_string(),
            FieldsMapper { offset: 3, size: 1 },
        );
        pe32.insert(
        ...
        pe32.insert(
            "MajorSubsystemVersion".to_string(),
            FieldsMapper {
                offset: 48,
                size: 2,
            },
        ...
        pe32.insert(
            "MinorSubsystemVersion".to_string(),
            FieldsMapper {
                offset: 50,
                size: 2,
            },
        ...
        Mapper {
            m_coff_fields_fields: coff_fields,
            m_pe32: pe32,
            m_pe32_plus: pe32plus,
        }
    }
